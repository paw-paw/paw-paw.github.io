...
- toma `docs/sdd/parches/sprint-2/block-0.md`, `docs/sdd/parches/sprint-2/block-1.md`, `docs/sdd/parches/sprint-2/block-2.md` y `docs/sdd/parches/sprint-2/block-3.md` como insumos aprobados y cerrados
...
- [x] verificar alineacion con `docs/sdd/parches/sprint-2/roadmap.md`
