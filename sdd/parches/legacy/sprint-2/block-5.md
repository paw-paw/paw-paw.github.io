...
- confirma que `docs/sdd/parches/sprint-2/roadmap.md` sigue siendo el roadmap activo para esta etapa
- revisa `docs/README.md`
- toma `docs/sdd/parches/sprint-2/block-0.md`, `docs/sdd/parches/sprint-2/block-1.md`, `docs/sdd/parches/sprint-2/block-2.md`, `docs/sdd/parches/sprint-2/block-3.md` y `docs/sdd/parches/sprint-2/block-4.md` como insumos aprobados y cerrados
...
- Depende de:
  ...
  - `docs/sdd/parches/sprint-2/block-0.md`
  - `docs/sdd/parches/sprint-2/block-1.md`
  - `docs/sdd/parches/sprint-2/block-2.md`
  - `docs/sdd/parches/sprint-2/block-3.md`
  - `docs/sdd/parches/sprint-2/block-4.md`
...
- [x] `docs/README.md`
- [x] `docs/sdd/parches/sprint-2/roadmap.md`
- [x] `docs/sdd/parches/sprint-2/block-0.md`
- [x] `docs/sdd/parches/sprint-2/block-1.md`
- [x] `docs/sdd/parches/sprint-2/block-2.md`
- [x] `docs/sdd/parches/sprint-2/block-3.md`
- [x] `docs/sdd/parches/sprint-2/block-4.md`
...
- [x] `docs/sdd/parches/sprint-2/block-5.md`
...
- `docs/sdd/parches/sprint-2/block-5.md`
- `docs/delivery/release-checklist.md`
...
- [ ] verificar alineacion con `docs/sdd/parches/sprint-2/roadmap.md`
