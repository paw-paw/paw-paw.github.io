...
- [ ] `docs/sdd/parches/sprint-1/roadmap.md` solo si la auditoria descubre que `0A` sigue mal definida
...
- `docs/sdd/parches/sprint-1/roadmap.md` solo si la auditoria obliga a refinar alcance
