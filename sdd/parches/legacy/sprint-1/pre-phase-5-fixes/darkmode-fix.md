...
- Depende de:
  ...
  - `docs/sdd/parches/sprint-1/pre-phase-5-fixes/pre-phase-5-work.md`
  - `docs/sdd/parches/sprint-1/pre-phase-5-fixes/exp-logos-patch.md`
  - `docs/sdd/parches/sprint-1/pre-phase-5-fixes/work-headers-patch.md`
- Desbloquea:
...
- [x] `docs/sdd/parches/sprint-1/pre-phase-5-fixes/pre-phase-5-work.md`
- [x] `docs/sdd/parches/sprint-1/pre-phase-5-fixes/exp-logos-patch.md`
- [x] `docs/sdd/parches/sprint-1/pre-phase-5-fixes/work-headers-patch.md`
...
- [x] `docs/sdd/parches/sprint-1/pre-phase-5-fixes/darkmode-fix.md`
...
- [ ] `docs/sdd/parches/sprint-1/pre-phase-5-fixes/pre-phase-5-work.md` si este patch se integra explícitamente como parte del trabajo puente activo
...
- `docs/sdd/parches/sprint-1/pre-phase-5-fixes/darkmode-fix.md`
