...
- `docs/sdd/parches/sprint-1/phase-0a.md`
...
- [x] `docs/README.md`
- [x] `docs/sdd/parches/sprint-1/roadmap.md`
- [x] `docs/sdd/templates/backlog-faseN.md`
- [x] `docs/sdd/parches/sprint-1/phase-0a.md`
...
- [x] `docs/sdd/parches/sprint-1/phase-0b.md`
...
- [ ] `docs/sdd/parches/sprint-1/roadmap.md`, salvo que aparezca una contradiccion nueva que obligue a refinar alcance
...
- `docs/governance/template-audit.md`
- `docs/governance/decision-log.md`
- `docs/sdd/parches/sprint-1/phase-0b.md`
