...
- Depende de:
  ...
  - `docs/sdd/parches/sprint-1/security-remediation-roadmap.md`
  - `docs/sdd/parches/sprint-1/SR/SR1.md`
...
- documentos auxiliares aplicables:
  - `docs/sdd/parches/sprint-1/security-remediation-roadmap.md`
  - `docs/sdd/parches/sprint-1/SR/SR1.md`
  - `docs/sdd/parches/sprint-1/phase-6.md`
...
- [x] `docs/sdd/parches/sprint-1/security-remediation-roadmap.md` en estado `active`
- [x] `docs/sdd/parches/sprint-1/SR/SR1.md` en estado `done`
...
- [x] `docs/sdd/parches/sprint-1/SR/SR2.md`

### Actualizar

- [x] `docs/sdd/parches/sprint-1/security-remediation-roadmap.md`
...
- [x] actualizar `docs/sdd/parches/sprint-1/security-remediation-roadmap.md`
...
- `docs/sdd/parches/sprint-1/SR/SR2.md`
- `docs/sdd/parches/sprint-1/security-remediation-roadmap.md`
- `docs/governance/decision-log.md`
...
- [ ] verificar alineacion con `docs/sdd/parches/sprint-1/roadmap.md`
- [ ] verificar alineacion con `docs/sdd/parches/sprint-1/security-remediation-roadmap.md`
