...
- [x] verificar listado de posts publicados en `es`

## Routing y links

- [ ] validar links internos principales
- [x] validar `LanguageSwitcher`
- [x] validar `LanguageSwitcher` en `blog post detail` con equivalente exacto localizado
...
- [x] confirmar paridad visible del blog en `es` con la version en ingles
