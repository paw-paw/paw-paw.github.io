...
- founders
- hiring managers
- leaders de operaciones o partnerships en gaming, esports y sectores adyacentes
- recruiters generalistas o managers no especializados que necesiten entender rapidamente el perfil
...
- gaming
- esports
- sectores adyacentes con programas remotos, multi-stakeholder o de delivery complejo
...
## Lo que debe entenderse en los primeros 10 segundos
...
El posicionamiento principal debe ser:

- gaming y esports primero
- sectores adyacentes como extension explicita, no como centro del relato
...
- alinea mejor con la audiencia primaria
- alinea con la mayor parte del material base en `temp/truth/`
- prepara el sitio para oportunidades remotas e internacionales antes de `Fase 5`
...
- empujar primero una conversion basada en evidencia
- permitir que la credibilidad anteceda al contacto
...
- ofrecer un siguiente paso natural despues de revisar evidencia
- mantener abierta la conversion hacia roles, conversaciones exploratorias o colaboraciones
...
El sitio no debe sonar:

- inflado
- autocelebratorio
- excesivamente startup-bro
- excesivamente corporativo
- excesivamente gamer o fan-facing

---

## Atributos de marca

Los atributos iniciales de marca son:
...
Estos atributos deben orientar:

- copy
- seleccion de evidencia
- visual direction en `Fase 3`
- tono de interaccion en `Fase 7`
...
## Lo que el sitio no debe comunicar

El sitio no debe comunicar que:

- eres un developer portfolio generico
- eres un creative portfolio centrado en diseno o branding
- eres un seller puro o un business development profile sin profundidad operativa
- eres un tournament admin narrow sin capacidad de traducir experiencia a program delivery mas amplia
- eres un founder-showcase centrado en ego o autobiografia
- el portfolio es un archivo exhaustivo de toda tu trayectoria

---

## Criterios de inclusion narrativos
...
## Criterios de descarte narrativos

Se debe excluir o relegar contenido que:

- sea verdadero pero no aporte al positioning principal
- desvie el sitio hacia CV exhaustivo o archivo historico
- dependa demasiado de jerga del ecosistema sin traduccion clara
- exponga datos personales no necesarios para credibilidad o contacto
- enfatice demasiado una narrativa alternativa no prioritaria
- cree una imagen demasiado fragmentada entre ops, BD, founder y analyst sin una tesis clara

---

## Rol estrategico de `temp/truth/`

`temp/truth/` cumple en esta fase un rol de:

- validacion de narrativa
- deteccion de evidencia util
- delimitacion de categorias que entran y categorias que no entran

`temp/truth/` no debe:

- definir por si solo la tesis del portfolio
- definir la arquitectura del sitio
- convertirse en copy aprobado
- arrastrar el formato de CV o archivo historico al portfolio
...
- definir arquitectura que soporte una narrativa de delivery first
- tratar `experience` y `projects` como pilares equivalentes de evidencia
- usar `education` como soporte de credibilidad, no como eje narrativo

### Para `Fase 3`

- la direccion visual debe reforzar confiabilidad, claridad y estructura
