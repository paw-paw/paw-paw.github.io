...
const seoContent: Record<SupportedLocale, Record<SeoPageKey, SeoEntry>> = {
  en: {
    ...
    blog: {
      ...
      description:
        'Professional writing by Paulo Tuya on business development, partnerships, project delivery, and the operating patterns behind reliable execution across gaming, esports, and remote programs.',
    },
  },
  es: {
    home: {
    ...
    blog: {
      ...
      description:
        'Escritos profesionales de Paulo Tuya sobre business development, alianzas, delivery de proyectos y los patrones de trabajo detras de una ejecucion confiable en gaming, esports y programas remotos.',
    },
  },
};
